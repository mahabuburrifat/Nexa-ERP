<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateSubSection.aspx.cs" Inherits="Nexa_ERP.HRMPAYROLL.CreateSubSection" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Create Sub Section</title>
</head>
            ...
            <div class="bg-[#f0f0f0] shadow-xl rounded-b-lg px-4 py-4">
                ...
                <div class="grid grid-cols-4 gap-x-4 gap-y-1.5">
                    ...
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Label9" runat="server" Text="Sub Section ID"></asp:Label>
                        <asp:TextBox ID="txtSubSectionId" ReadOnly="true" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Label1" runat="server" Text="Section Name"></asp:Label>
                        <asp:DropDownList ID="ddlSectionName" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:DropDownList>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Label2" runat="server" Text="Line Name"></asp:Label>
                        <asp:TextBox ID="txtLineName" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Label3" runat="server" Text="Bangla Name"></asp:Label>
