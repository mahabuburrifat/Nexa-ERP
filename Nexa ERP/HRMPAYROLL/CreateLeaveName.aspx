<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLeaveName.aspx.cs" Inherits="Nexa_ERP.HRMPAYROLL.CreateLeaveName" %>
            ...
            <div class="bg-[#f0f0f0] shadow-xl rounded-b-lg px-4 py-4">
                ...
                <div class="grid grid-cols-3 gap-x-4 gap-y-1.5">
                    <div class="flex flex-col gap-0.5 w-full">
                        ...
                        <asp:TextBox ID="txtLeaveId" ReadOnly="true" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Label1" runat="server" Text="Leave Name"></asp:Label>
                        <asp:DropDownList ID="ddlLeaveName" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:DropDownList>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                    ...
                    <div class="flex flex-col gap-0.5 w-full">
                        ...
                        <asp:TextBox ID="txtShortName" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Label7" runat="server" Text="Leave Days"></asp:Label>
                        <asp:TextBox ID="txtLeaveDays" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                        <asp:Label ID="Labe8" runat="server" Text="Sex"></asp:Label>
                        <asp:DropDownList ID="ddlSex" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:DropDownList>
                    </div>
                </div>
