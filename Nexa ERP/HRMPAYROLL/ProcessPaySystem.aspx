<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessPaySystem.aspx.cs" Inherits="Nexa_ERP.HRMPAYROLL.ProcessPaySystem" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Process Pay System</title>
    ...
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <div class="bg-[#0d6efd] text-white rounded-t-lg px-4 py-2">
                <p class="text-2xl mb-1">Process Pay System</p>
                <p class="">Label</p>
            </div>
